                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.Card(
                                children=[
                                    html.H3(children="Team", className="text-center"),
                                    html.H1(id="teamOfDev", className="text-center"),
                                ],
                                body=True,
                                color="dark",
                                outline=True,
                        ...
                        dbc.Col(
                            dbc.Card(
                                children=[
                                    ...
                                    html.H1(id="totalAdded", className="text-center"),
                                ],
                                body=True,
                                color="primary",
                                outline=True,
                        ...
                        dbc.Col(
                            dbc.Card(
                                children=[
                                    ...
                                    html.H1(id="totalDeleted", className="text-center"),
                                ],
                                body=True,
                                color="primary",
                                outline=True,
